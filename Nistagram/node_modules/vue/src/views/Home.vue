...
export default {
  ...
  methods: {
		Registration(){
			this.Reset()
      this.account1.name=document.getElementById("name").value
      this.account1.surname=document.getElementById("surname").value
      this.account1.username=document.getElementById("username").value
      this.account1.password=document.getElementById("password1").value
      this.account1.phoneNumber=document.getElementById("phone").value
      this.account1.email=document.getElementById("email").value
      this.account1.dateOfBirth=document.getElementById("date").value
      if(document.getElementById("male").checked == true){
         this.account1.gender = "MALE"    
      }else{ 
          this.account1.gender = "FEMALE"
      }
      this.user.account=this.account1
      if(this.Validation()){
