  ...
  <div id="Profile">
            <div class="col-md-12">
                    <div class="bg-white shadow rounded overflow-hidden divs">
                        ...
                        <h2 class="mt-0 mb-0">{{hashtagName}}</h2>           
                        <div>
...
import { myHashtag } from '../components/Search.vue'
...
export default {
  ...
  data: function () {
        ...
        this.hashtagId = myHashtag.id
        //alert(this.hashtagId)
        this.hashtagName = myHashtag.name
       await  axios
                .get("http://localhost:8080/api/post/getPostsByHashtag/" + this.hashtagId + '/' + localStorage.getItem('userId'),
				{
							headers: {
                ...
                .then(response => {
                  if (response.status==200){
                    ...
                    for(let a = 0; a < response.data.length; a++){
                         ...
                         axios
                              .get("http://localhost:8080/api/user/checkPublic/" + localStorage.getItem('userId') + '/' +response.data[a].userId,
                      {
                            headers: {
                              'Authorization': 'Bearer' + " " + localStorage.getItem('token')
                            }
                              ...
                              .then(response1 => {
                                if (response1.status==200){
                                  if(response1.data){
                                    ...
                                    alert(this.pict[0].images[0].img)
                                }
            ...
            await  axios
                ...
                await  axios
                .get("http://localhost:8080/api/post/getStoriesByHashtag/" + this.hashtagId + '/' + localStorage.getItem('userId'),
				{
							headers: {
								'Authorization': 'Bearer' + " " + localStorage.getItem('token')
							}
                              ...
                              .then(response1 => {
                                if (response1.status==200){
                                  if(response1.data){
                                    ...
                                    alert(this.stories[0].images[0].img)
                                }
